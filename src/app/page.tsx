  ...
  return (
    <div className={styles.page}>
        ...
        <div>
          <div className={styles.intro}>
            ...
            <p>
              ...
              diverse set of outputs derived from curiosity, computational
              logic, and occasional unpredictability. You are invited to explore
              the results of these activities. Your engagement is both expected
              and welcomed. Thank you for visiting.
            </p>
            <p
              className={styles.quote}
              style={{
      ...
      <Link className={styles.navButton} href="/archery">
        ...
        <Link
          className={styles.navButton}
          href="https://github.com/ShiCheng-Lu"
        >
          More of PROgrammer 💻
        </Link>
      ...
      <footer>
        {!isMobile &&
          !cookies.disable8Ball &&
          initialized &&
          magic8BallOpen && <Magic8Ball />}

        {!isMobile && !cookies.acceptedPolicy && initialized && (
          <PrivacyPolicy />
        )}
